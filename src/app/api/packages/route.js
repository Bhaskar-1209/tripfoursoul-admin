...
export async function POST(request) {
  try {
    ...
    const { destination_id, title, days, meals, short_description, long_description, sub_heading, itinerary, additional_info, image_url, inclusives, exclusives, price, sort_order = 0 } = body;
...
export async function PUT(request) {
  try {
    const body = await request.json();
    const { id, destination_id, title, days, meals, short_description, long_description, sub_heading, itinerary, additional_info, image_url, inclusives, exclusives, price, sort_order = 0 } = body;
