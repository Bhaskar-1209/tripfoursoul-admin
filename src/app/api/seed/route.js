...
export async function GET() {
  try {
    ...
    const packages = [
      ...
      { destination_id: null, title: 'Swiss Alps Explorer', slug: 'swiss-alps-explorer', days: '7 Days / 6 Nights', meals: '', short_description: 'Experience the breathtaking beauty of the Swiss Alps with this 7-day adventure.', long_description: 'Experience the breathtaking beauty of the Swiss Alps with this 7-day adventure.', sub_heading: 'Hot Deal', image_url: 'https://images.unsplash.com/photo-1531366936337-7c912a4589a7?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '€2,499', sort_order: 5, is_trending: true, is_active: true },
      { destination_id: null, title: 'Maldives Retreat', slug: 'maldives-retreat', days: '5 Days / 4 Nights', meals: '', short_description: 'Relax in the beautiful Maldives with crystal clear waters and luxurious overwater bungalows.', long_description: 'Relax in the beautiful Maldives with crystal clear waters and luxurious overwater bungalows.', sub_heading: 'Best Seller', image_url: 'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '$1,899', sort_order: 6, is_trending: true, is_active: true },
      { destination_id: null, title: 'Moroccan Sahara', slug: 'moroccan-sahara', days: '8 Days / 7 Nights', meals: '', short_description: 'Explore the magic of Morocco with visits to Marrakech, Fez, and the Sahara Desert.', long_description: 'Explore the magic of Morocco with visits to Marrakech, Fez, and the Sahara Desert.', sub_heading: 'Trending', image_url: 'https://images.unsplash.com/photo-1489749798305-4fea3ae63d43?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '$1,299', sort_order: 7, is_trending: true, is_active: true },
      { destination_id: null, title: 'Japan Cherry Blossom', slug: 'japan-cherry-blossom', days: '10 Days / 9 Nights', meals: '', short_description: 'Witness the beautiful cherry blossoms in Japan during peak bloom season.', long_description: 'Witness the beautiful cherry blossoms in Japan during peak bloom season.', sub_heading: 'Popular', image_url: 'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '$2,199', sort_order: 8, is_trending: true, is_active: true },
      { destination_id: null, title: 'Bali Wellness Escape', slug: 'bali-wellness-escape', days: '6 Days / 5 Nights', meals: '', short_description: 'Rejuvenate your mind and body with yoga, meditation, and spa treatments in Bali.', long_description: 'Rejuvenate your mind and body with yoga, meditation, and spa treatments in Bali.', sub_heading: 'New', image_url: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '$1,499', sort_order: 9, is_trending: true, is_active: true },
      { destination_id: null, title: 'Greek Island Hopping', slug: 'greek-island-hopping', days: '9 Days / 8 Nights', meals: '', short_description: 'Explore the beautiful Greek islands including Santorini, Mykonos, and Athens.', long_description: 'Explore the beautiful Greek islands including Santorini, Mykonos, and Athens.', sub_heading: 'Popular', image_url: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '€1,799', sort_order: 10, is_trending: true, is_active: true },
      { destination_id: 5, title: 'Varanasi & Ganga Aarti', slug: 'varanasi-ganga-aarti', days: '5 Days / 4 Nights', meals: '', short_description: 'A restorative journey through Varanasi with sunrise boat rides, temple visits, guided meditation, and the evening Ganga Aarti.', long_description: 'A restorative journey through Varanasi with sunrise boat rides, temple visits, guided meditation, and the evening Ganga Aarti.', sub_heading: 'Sacred Journey', image_url: 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '₹24,999', sort_order: 11, is_spiritual: true, is_active: true },
      { destination_id: 3, title: 'Rishikesh Yoga Retreat', slug: 'rishikesh-yoga-retreat', days: '6 Days / 5 Nights', meals: '', short_description: 'Reconnect with yourself beside the Ganges through daily yoga, breathwork, guided meditation, and peaceful Himalayan walks.', long_description: 'Reconnect with yourself beside the Ganges through daily yoga, breathwork, guided meditation, and peaceful Himalayan walks.', sub_heading: 'Wellness Pick', image_url: 'https://images.unsplash.com/photo-1500534623283-312aade485b7?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '₹29,999', sort_order: 12, is_spiritual: true, is_active: true },
      { destination_id: null, title: 'Bodh Gaya Mindfulness Tour', slug: 'bodh-gaya-mindfulness-tour', days: '4 Days / 3 Nights', meals: '', short_description: 'Follow the Buddhist path in Bodh Gaya with monastery visits, mindful sessions, and time for quiet reflection under the Bodhi tree.', long_description: 'Follow the Buddhist path in Bodh Gaya with monastery visits, mindful sessions, and time for quiet reflection under the Bodhi tree.', sub_heading: 'Mindful Escape', image_url: 'https://images.unsplash.com/photo-1609947017136-9daf32a5eb16?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '₹22,999', sort_order: 13, is_spiritual: true, is_active: true },
      { destination_id: null, title: 'Kedarnath Pilgrimage', slug: 'kedarnath-pilgrimage', days: '7 Days / 6 Nights', meals: '', short_description: 'Undertake a carefully planned Himalayan pilgrimage to Kedarnath with comfortable stays, local guidance, and meaningful temple time.', long_description: 'Undertake a carefully planned Himalayan pilgrimage to Kedarnath with comfortable stays, local guidance, and meaningful temple time.', sub_heading: 'Popular', image_url: 'https://images.unsplash.com/photo-1587474260584-136574528ed5?w=700&q=80', inclusives: '', exclusives: '', itinerary: '', additional_info: '', price: '₹34,999', sort_order: 14, is_spiritual: true, is_active: true }
    ];
