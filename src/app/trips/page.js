    ...
    try {
      if (editingTrip) {
        await fetch("/api/trips", {
          ...
          body: JSON.stringify({ ...form, id: editingTrip.id, is_active: 1, sort_order: editingTrip.sort_order || 0 }),
        });
      ...
      setForm({ name: "", description: "", image_url: "", price: "", duration: "", days: "", location: "", category: "trending", badge: "", destination_id: "" });
      setShowForm(false);
      setEditingTrip(null);
      fetchTrips();
    } catch (error) { 
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="admin-card">
          <div className="flex items-center justify-between mb-6">
            ...
            <button 
              onClick={() => { setShowForm(true); setEditingTrip(null); setForm({ name: "", description: "", image_url: "", price: "", duration: "", days: "", location: "", category: "trending", badge: "", destination_id: "" }); }}
              className="admin-btn"
            >
              Add New Trip
            </button>
          ...
          {(showForm || editingTrip) && (
            <div className="bg-gray-50 p-6 rounded-lg mb-6 space-y-4">
              <h3 className="text-lg font-semibold mb-4">{editingTrip ? "Edit Trip" : "Add New Trip"}</h3>
